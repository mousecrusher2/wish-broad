    ...
    <section className="space-y-4">
      ...
      <div className="space-y-3">
        ...
        <div className="h-72 rounded-xl border border-white/10 bg-slate-950/30">
          <div className="h-full [scrollbar-width:thin] [overflow-y:overlay] px-2 py-2 [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-white/15 hover:[&::-webkit-scrollbar-thumb]:bg-white/25 [&::-webkit-scrollbar-track]:bg-transparent">
